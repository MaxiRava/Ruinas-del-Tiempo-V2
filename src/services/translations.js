import { ES_AR } from "../enums/languages.js";
...
export async function getTranslations(lang = language) {
  ...
  language = lang;
  return await fetch(
    `https://traduci-la.herokuapp.com/rest/translation?project_id=${PROJECT_ID}&lang=${lang}`
  )
    //return await fetch(`https://traduci-la-strapi.herokuapp.com/api/translations/38/en-US`)
